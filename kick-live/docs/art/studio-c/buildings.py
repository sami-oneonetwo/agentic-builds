"""buildings.py - studio-c building kit (SETTLEMENT top-down, 3/4 view).
...
def hut(name: str, w_tiles: int = 1, lit: bool = False) -> Tuple[np.ndarray, Tuple[int, int]]:
    ...
    kind = _h(name, 1) % 3
    d.ellipse(ox + fw / 2.0, oy + T - 3, fw / 2.0 + 4, 5, (20, 24, 12, 70))           # ground shadow
...
if __name__ == "__main__":
    ...
    kit_image(names).save("/Users/sandy/Workspace/agentic-builds/kick-live/docs/art/studio-c/building_kit.png")
    print("ok")
