"""hud.py - studio-c HUD style sheet + drawing helpers (SETTLEMENT top-down).
...
def pill(text: str, dot: Optional[Tuple[int, int, int]] = None, tail: bool = True) -> Image.Image:
    """Show-on-speak name pill for the world: dark rounded pill, cream text (20 px), a dot in the creature colour
    and a small tail pointing down at the creature. Returns RGBA."""
...
if __name__ == "__main__":
    style_sheet_image().save("/Users/sandy/Workspace/agentic-builds/kick-live/docs/art/studio-c/hud_style.png")
    print("ok")
